...
export const Route = createFileRoute("/practice")({
  head: () => ({
    meta: [
      { title: "Practice With Us · Yoga Classes in Malad & Kandivali West" },
      {
        name: "description",
        content:
          "Authentic yoga classes in Malad & Kandivali West and live online classes across India. 3 or 5 days a week, 60-minute morning sessions, suitable for beginners.",
      },
    ],
  }),
  component: Practice,
  ...
  return (
    <Layout>
      <PageHero
        ...
        intro="Morning live classes in Malad and online sessions across India — each practice extends far beyond physical postures."
        image={practiceImg}
      />
